    ...
    <div>
        ...
        <trax-ui-form :id="id" icons="1" :form="form" :form-extend="formExtend" :action="action" :bus="bus">
            ...
            <trax-ui-input type="email" icon="email" :placeholder="lang.trax_account.common.email"
                v-model="form.email" v-bind:error="errors.email" :required="!emailDisabled" 
                :disabled="emailDisabled || requiredDisabled">
            </trax-ui-input>
...
<script>
    export default {
        ...
        computed: {
            ...
            requiredDisabled() {
                return this.myProfile && this.disableRequiredFields;
            },
        },
